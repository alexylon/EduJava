...
public class String_Methods_Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("First letter: " + name.trim().charAt(0));
        System.out.println("The index of " + name.trim().charAt(0) + " is: "
                + name.trim().indexOf("A"));
        ...
        System.out.println(fullName.replace(" ", " Kroumov "));
        ...
        System.out.println("My last name is: " + fullName.substring(10));
        System.out.println("My name is lawful: " + firstName.substring(1, 4));

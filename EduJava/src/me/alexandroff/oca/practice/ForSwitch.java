...
//so when i is equal to 0, nothing gets printed and i is incremented
// to 1 (due to i++ in the switch).
...
//when i = 4, "E" is printed and since there is no break, it falls
// through to case 'E' and "F" is printed.
//i is incremented to 5  (due to i++ in the switch) and then
// it is again incremented to 6 by the for loop.
